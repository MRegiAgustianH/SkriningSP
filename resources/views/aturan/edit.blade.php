    ...
    <section class="content-header mx-3 mt-3">
        <div class="container-fluid">
            <div class="row mb-3 align-items-center">
                <div class="col-sm-8">
                    <h1 class="page-header"><i class="fas fa-edit text-warning mr-2"></i> Ubah Data Aturan</h1>
                    <p class="text-muted mb-0">Perbarui relasi antara tingkat kecanduan, gejala, dan nilai kepastian (CF Pakar).</p>
                </div>
            </div>
        </div>
    </section>
                        ...
                        <form action="{{ route('aturan.update', $aturan->id) }}" method="post">
                                ...
                                <div class="input-group">
                                    ...
                                    <select name="kecanduan_id" id="kecanduan_id" class="form-control select2 @error('kecanduan_id') is-invalid @enderror" required>
                                        ...
                                        @foreach ($kecanduan as $row)
                                            <option value="{{ $row->id }}" {{ old('kecanduan_id', $aturan->kecanduan_id) == $row->id ? 'selected' : '' }}>
                                ...
                                <div class="input-group">
                                    ...
                                    <select name="gejala_id" id="gejala_id" class="form-control select2 @error('gejala_id') is-invalid @enderror" required>
                                        ...
                                        @foreach ($gejala as $row)
                                            <option value="{{ $row->id }}" {{ old('gejala_id', $aturan->gejala_id) == $row->id ? 'selected' : '' }}>
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" step="0.1" class="form-control input-custom has-icon @error('cf_pakar') is-invalid @enderror" name="cf_pakar" id="cf_pakar" value="{{ old('cf_pakar', $aturan->cf_pakar) }}" placeholder="Contoh: 0.8" required>
                                </div>
