    ...
    <section class="content-header mx-3 mt-3">
        <div class="container-fluid">
            <div class="row mb-3 align-items-center">
                <div class="col-sm-8">
                    <!-- Icon disesuaikan dengan tema ungu -->
                    <h1 class="page-header"><i class="fas fa-plus-circle text-indigo mr-2" style="color: #667eea;"></i> Tambah Artikel</h1>
                    <p class="text-muted mb-0">Silakan buat artikel atau informasi edukasi yang baru.</p>
                </div>
            </div>
        </div>
    </section>
                        ...
                        <form action="{{ route('artikel.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control input-custom has-icon @error('judul') is-invalid @enderror" name="judul" id="judul" value="{{ old('judul') }}" placeholder="Masukkan judul artikel...">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <small class="text-muted mt-2 d-block"><i class="fas fa-info-circle mr-1"></i> Format yang didukung: JPG, JPEG, PNG.</small>
                            ...
                            <div class="form-group mb-4">
                                ...
                                <textarea class="form-control tinymce @error('isi') is-invalid @enderror" name="isi" id="isi" rows="10" placeholder="Tuliskan isi artikel Anda di sini...">{{ old('isi') }}</textarea>
                            ...
                            <div class="d-flex justify-content-end mt-4">
                                ...
                                <button type="submit" class="btn btn-save-modern">
                                    <i class="fas fa-paper-plane mr-1"></i> Simpan & Publikasi
                                </button>
                            </div>
                        </form>
                    </div>
